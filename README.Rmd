...
To make sure all releases work just fine (especially since Rcpp needs to be built). I will include the file .travisyml and register this repository. Below are the banners provided. 
